...
export STEM_LLM_JUDGE_URL="http://144.214.209.226:8000"  # Fill in the llm-as-judge hosted URL, currently used only in 'STEM' domain
...
hitab_train_path_s1=${TRAIN_DATA_DIR}/table__hitab_0.2k_1_attack.parquet
hitab_train_path_s1_meta=${TRAIN_DATA_DIR}/table__hitab_0.2k_1_meta.parquet
hitab_train_path_s2=${TRAIN_DATA_DIR}/table__hitab_0.2k_2_attack.parquet
hitab_train_path_s2_meta=${TRAIN_DATA_DIR}/table__hitab_0.2k_2_meta.parquet
hitab_train_path_s3=${TRAIN_DATA_DIR}/table__hitab_0.2k_3_attack.parquet
...
hitab_test_path=${TEST_DATA_DIR}/table__hitab_1k_attack.parquet
...
train_files="['${hitab_train_path_s1}']"  # Use math as example, add to more tasks as needed
test_files="['${hitab_test_path}']"  # Use math as example, add to more tasks as needed

# =================== Model ===================
BASE_MODEL=/home/hmpiao/adv_reason/Reasoning360/checkpoints/Reasoning360-1.7B/--Qwen3-1.7B-Base-think-qwen2chat-sftjudge-ke-1-e6-s1-directcotstepjudge-frompretrain-0.2-attacker/global_step_20/actor/Qwen3-1.7B-Base-think-qwen2chat-sftjudge-ke-1-e6-s1-step20-directcotstepjudge-frompretrain-0.2-attacker  # Note: This is the original Qwen32B-Base model. In training, we add 'think' system prompt to it (see README).

# =================== Logging ===================
WANDB_PROJECT=Reasoning360-1.7B
WANDB_EXPERIMENT_NAME=${SLURM_JOB_ID}-${SLURM_JOB_NAME}-${BASE_MODEL##*/}-e6-s1-direct-frompretrain-0.2-attack2
