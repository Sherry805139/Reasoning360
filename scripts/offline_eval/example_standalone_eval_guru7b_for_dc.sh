...
SHARED_DATA_PATH=/home/hmpiao/adv_reason/Reasoning360/data/train
data_folder=${SHARED_DATA_PATH}/
save_folder=./evaluation_results/test_offline_leaderboard_output_for_dc_sample/
model_path=/home/hmpiao/adv_reason/Reasoning360/checkpoints/Reasoning360-1.7B/--Qwen3-1.7B-Base-think-qwen2chat-sft-2-e6-s2-directcotstep-frompretrain-0.2/global_step_40/actor/Qwen3-1.7B-Base-think-qwen2chat-sft-2-e6-s2-step40-directcotstep-frompretrain-0.2
...
for leaderboard in "${leaderboard_list[@]}"; do
    ...
    data_file="/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_2.parquet"
