...
train_files="['${hitab_train_path_s1}', '${hitab_train_path_s1}', '/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_1_sftjudge.parquet', '/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_1_sftjudge_ke.parquet', '/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_1_sftjudge_ke.parquet']"  # Use math as example, add to more tasks as needed
test_files="['${hitab_test_path}']"  # Use math as example, add to more tasks as needed

# =================== Model ===================
BASE_MODEL=/home/hmpiao/hmpiao/Qwen3-1.7B-Base-think-qwen2chat-sftjudge-ke-1/Qwen3-1.7B-Base-think-qwen2chat-sftjudge-ke-1  # Note: This is the original Qwen32B-Base model. In training, we add 'think' system prompt to it (see README).

# =================== Logging ===================
WANDB_PROJECT=Reasoning360-1.7B
WANDB_EXPERIMENT_NAME=${SLURM_JOB_ID}-${SLURM_JOB_NAME}-${BASE_MODEL##*/}-e6-s1-directcotstepjudge-frompretrain-0.2-attacker
