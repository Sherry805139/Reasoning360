...
# =================== Data Mixture ===================
SHARED_DATA_PATH=/mnt/afs/codes/hwang/Reasoning360/data
...
hitab_train_path_s1=${TRAIN_DATA_DIR}/table__hitab_1.4k_1.parquet
hitab_train_path_s2=${TRAIN_DATA_DIR}/table__hitab_1.4k_2.parquet
hitab_train_path_s3=${TRAIN_DATA_DIR}/table__hitab_1.4k_3.parquet
...
train_files="['${hitab_train_path}']"  # Use math as example, add to more tasks as needed
test_files="['${hitab_test_path}']"  # Use math as example, add to more tasks as needed

# =================== Model ===================
BASE_MODEL=/mnt/afs/codes/hwang/Reasoning360/model/Qwen_Qwen2.5-3B-think  # Note: This is the original Qwen32B-Base model. In training, we add 'think' system prompt to it (see README).

# =================== Logging ===================
WANDB_PROJECT=Reasoning360
WANDB_EXPERIMENT_NAME=${SLURM_JOB_ID}-${SLURM_JOB_NAME}-${BASE_MODEL##*/}-grpo
