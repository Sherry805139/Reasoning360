...
SHARED_DATA_PATH=/home/hmpiao/adv_reason/Reasoning360/data/offline_eval
data_folder=${SHARED_DATA_PATH}/
save_folder=./evaluation_results/test_offline_leaderboard_output/
model_path=/home/hmpiao/adv_reason/Reasoning360/checkpoints/Reasoning360-1.7B/--Qwen3-1.7B-Base-think-qwen2chat-sftjudge-ke-1-e6-s1-step20-directcotstepjudge-frompretrain-0.2-attacker-e6-s1-direct-frompretrain-0.2-attack2/global_step_40/actor/Qwen3-1.7B-Base-think-qwen2chat-sftjudge-ke-1-e6-s1-step20-directcotstepjudge-frompretrain-0.2-attacker-e6-s1-direct-frompretrain-0.2-attack2
...
for leaderboard in "${leaderboard_list[@]}"; do
    ...
    data_file="/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_1_attack.parquet"
